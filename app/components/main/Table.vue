...
<template>
  <table class="w-full caption-bottom">
    ...
    <tbody>
      ...
      >
        <td class="text-center p-2">{{ game.stats.language }}</td>
        <td class="text-center p-2">{{ game.stats.time }}</td>
        <td class="text-center p-2">{{ game.stats.wpm }}</td>
        <td class="text-center p-2">{{ game.stats.raw }}</td>
        <td class="text-center p-2">{{ game.stats.errors }}</td>
